...
namespace Mammothcode.Core.Data.DataWeb
{
    /// <summary>
    /// Web操作的公共类
    /// </summary>
    public class WebHelperUtil
    {
        ...
        /// HTML解码
        /// </summary>
        /// <returns>返回解密后带有Html标签的文本</returns>
        ...
        public static void SetCookie(string name, string value, double expires)
        {
            ...
            TimeSpan ts = new TimeSpan(7, 0, 0, 0, 0);//过期时间为7天
        ...
        public static void SessionAdd(string strSessionName, string strValue, int iExpires=20)
        {
        ...
        /// <summary>
        /// 添加Session值数组，调动有效期为20分钟
        /// </summary>
        /// <param name="strSessionName">Session对象名称</param>
        /// <param name="strValues">Session值数组</param>
        public static void SessionAdds(string strSessionName, string[] strValues, int iExpires = 20)
        {
        ...
        public static string[] SessionGets(string strSessionName)
        {
            if (HttpContext.Current.Session[strSessionName] == null)
            {
                return null;
        ...
        /// </summary>
        /// <param name="strSessionName">Session对象名称</param>
        public static void SessionDel(string strSessionName)
        {
