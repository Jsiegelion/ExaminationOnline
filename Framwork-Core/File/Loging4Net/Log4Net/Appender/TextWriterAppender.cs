...
namespace Mammothcode.Public.Core.Appender
{
	...
	public class TextWriterAppender : AppenderSkeleton
	{
		...
		/// <summary>
		/// Gets or sets the <see cref="Mammothcode.Public.Core.Util.QuietTextWriter"/> where logging events
		/// will be written to. 
		/// </summary>
		/// <value>
		/// The <see cref="Mammothcode.Public.Core.Util.QuietTextWriter"/> where logging events are written.
		/// </value>
		/// <remarks>
		/// <para>
		/// This is the <see cref="Mammothcode.Public.Core.Util.QuietTextWriter"/> where logging events
		/// will be written to. 
		/// </para>
		/// </remarks>
