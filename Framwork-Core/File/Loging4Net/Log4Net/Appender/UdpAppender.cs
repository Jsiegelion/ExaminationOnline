...
using Mammothcode.Public.Core.Layout;
using Mammothcode.Public.Core.Core;
using Mammothcode.Public.Core.Util;

namespace Mammothcode.Public.Core.Appender 
{
	/// <summary>
	...
	///     <layout type="Mammothcode.Public.Core.Layout.PatternLayout" value="%-5level %logger [%ndc] - %message%newline" />
	/// </appender>
	/// </code>
	/// </example>
	...
	public class UdpAppender : AppenderSkeleton
	{
		...
		public int RemotePort
		{
			...
			set 
			{
				...
				{
					throw Mammothcode.Public.Core.Util.SystemInfo.CreateArgumentOutOfRangeException("value", (object)value,
		...
		public override void ActivateOptions()
		{
			...
			{
				throw Mammothcode.Public.Core.Util.SystemInfo.CreateArgumentOutOfRangeException("this.RemotePort", (object)this.RemotePort,
			...
			{
				throw Mammothcode.Public.Core.Util.SystemInfo.CreateArgumentOutOfRangeException("this.LocalPort", (object)this.LocalPort,
