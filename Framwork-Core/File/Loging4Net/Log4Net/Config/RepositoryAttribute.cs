...
namespace Mammothcode.Public.Core.Config
{
	...
	/// specifies the type of the <see cref="Mammothcode.Public.Core.Repository.ILoggerRepository"/> object 
	...
	public /*sealed*/ class RepositoryAttribute : Attribute
	{
		...
		/// The type must implement the <see cref="Mammothcode.Public.Core.Repository.ILoggerRepository"/>
		/// interface.
		/// </para>
		/// <para>
