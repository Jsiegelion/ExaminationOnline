...
using Mammothcode.Public.Core.Appender;
...
namespace Mammothcode.Public.Core.Core
{
	...
	public class CompactRepositorySelector : IRepositorySelector
	{
		...
		public CompactRepositorySelector(Type defaultRepositoryType)
		{
			...
			{
				throw Mammothcode.Public.Core.Util.SystemInfo.CreateArgumentOutOfRangeException("defaultRepositoryType", (object)defaultRepositoryType, "Parameter: defaultRepositoryType, Value: ["+defaultRepositoryType+"] out of range. Argument must implement the ILoggerRepository interface");
			}
