...
namespace Mammothcode.Public.Core.Core
{
	...
	/// </para>
	/// <para>
	/// The levels that are recognized by log4net are set for each <see cref="Mammothcode.Public.Core.Repository.ILoggerRepository"/>
	/// and each repository can have different levels defined. The levels are stored
	/// in the <see cref="Mammothcode.Public.Core.Repository.ILoggerRepository.LevelMap"/> on the repository. Levels are
	/// looked up by name from the <see cref="Mammothcode.Public.Core.Repository.ILoggerRepository.LevelMap"/>.
	/// </para>
	/// <para>
