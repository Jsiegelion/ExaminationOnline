...
namespace Mammothcode.Public.Core.Core
{
	...
	/// the <see cref="RepositorySelector"/> property, or by setting the <c>Mammothcode.Public.Core.RepositorySelector</c>
	...
	public sealed class LoggerManager
	{
		...
		static LoggerManager()
		{
...
#if NETCF
			s_repositorySelector = new CompactRepositorySelector(typeof(Mammothcode.Public.Core.Repository.Hierarchy.Hierarchy));
#else

			// Look for the RepositorySelector type specified in the AppSettings 'Mammothcode.Public.Core.RepositorySelector'
			string appRepositorySelectorTypeName = SystemInfo.GetAppSetting("Mammothcode.Public.Core.RepositorySelector");
			...
			{
				s_repositorySelector = new DefaultRepositorySelector(typeof(Mammothcode.Public.Core.Repository.Hierarchy.Hierarchy));
			}
#endif
		}
		...
		/// <see cref="Mammothcode.Public.Core.Repository.Hierarchy.Hierarchy"/> object.
		/// </para>
		/// <para>
