...
namespace Mammothcode.Public.Core
{
	...
	/// be included in the output of log messages. The <see cref="Mammothcode.Public.Core.Layout.PatternLayout"/>
	...
	public sealed class GlobalContext
	{
		...
		{
			Properties[Mammothcode.Public.Core.Core.LoggingEvent.HostNameProperty] = SystemInfo.HostName;
		}
