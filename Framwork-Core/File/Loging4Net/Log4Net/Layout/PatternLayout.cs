...
using Mammothcode.Public.Core.Core;
using Mammothcode.Public.Core.Layout.Pattern;
using Mammothcode.Public.Core.Util;
using Mammothcode.Public.Core.Util.PatternStringConverters;
using AppDomainPatternConverter=Mammothcode.Public.Core.Layout.Pattern.AppDomainPatternConverter;
using DatePatternConverter=Mammothcode.Public.Core.Layout.Pattern.DatePatternConverter;
using IdentityPatternConverter=Mammothcode.Public.Core.Layout.Pattern.IdentityPatternConverter;
using PropertyPatternConverter=Mammothcode.Public.Core.Layout.Pattern.PropertyPatternConverter;
using UserNamePatternConverter=Mammothcode.Public.Core.Layout.Pattern.UserNamePatternConverter;
using UtcDatePatternConverter=Mammothcode.Public.Core.Layout.Pattern.UtcDatePatternConverter;

namespace Mammothcode.Public.Core.Layout
{
	/// <summary>
	...
	/// 			</para>
	/// 			<para>
	/// 			For example, for the class name "Mammothcode.Public.Core.Layout.PatternLayout", the
