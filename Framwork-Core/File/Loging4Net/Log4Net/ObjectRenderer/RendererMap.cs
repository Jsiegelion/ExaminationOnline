...
namespace Mammothcode.Public.Core.ObjectRenderer
{
	/// <summary>
			...
			else 
			{
				...
				else
				{
					...
					catch(Exception ex)
					{
						...
						Mammothcode.Public.Core.Util.LogLog.Error(declaringType, "Exception while rendering object of type ["+obj.GetType().FullName+"]", ex);
