...
namespace Mammothcode.Public.Core.Plugin
{
	/// <summary>
	...
	/// with a <see cref="Mammothcode.Public.Core.Repository.ILoggerRepository"/>.
	/// The <see cref="PluginMap"/> held by the <see cref="Mammothcode.Public.Core.Repository.ILoggerRepository.PluginMap"/>
	/// property is used to store the plugins for a repository.
	/// </para>
	/// <para>
	/// The <c>Mammothcode.Public.Core.Config.PluginAttribute</c> can be used to
