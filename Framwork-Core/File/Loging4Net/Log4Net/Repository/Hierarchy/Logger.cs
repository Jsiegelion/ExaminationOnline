	...
	public abstract class Logger : IAppenderAttachable, ILogger
	{
		...
		virtual public void AddAppender(IAppender newAppender) 
		{
			...
			try
			{
				...
				{
					m_appenderAttachedImpl = new Mammothcode.Public.Core.Util.AppenderAttachedImpl();
				}
		...
		/// </summary>
		private Mammothcode.Public.Core.Util.AppenderAttachedImpl m_appenderAttachedImpl;
