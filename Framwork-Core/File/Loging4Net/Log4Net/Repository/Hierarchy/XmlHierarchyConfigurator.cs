...
using Mammothcode.Public.Core.ObjectRenderer;

namespace Mammothcode.Public.Core.Repository.Hierarchy
{
	/// <summary>
	...
	public class XmlHierarchyConfigurator
	{
		...
		protected void ParseLogger(XmlElement loggerElement) 
		{
			...
			LogLog.Debug(declaringType, "Retrieving an instance of Mammothcode.Public.Core.Repository.Logger for logger [" + loggerName + "].");
