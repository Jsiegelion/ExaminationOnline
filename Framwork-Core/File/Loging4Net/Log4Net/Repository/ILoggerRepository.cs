...
using Mammothcode.Public.Core.Plugin;
using Mammothcode.Public.Core.Repository.Hierarchy;
using Mammothcode.Public.Core.Util;

namespace Mammothcode.Public.Core.Repository
{
	...
	public interface ILoggerRepository
	{
		...
		/// </para>
		/// </remarks>
		Mammothcode.Public.Core.Appender.IAppender[] GetAppenders();
	}
}
