...
namespace Mammothcode.Public.Core.Util
{
	...
	/// <c>Mammothcode.Public.Core.Util.LogicalThreadContextProperties</c>.
	/// </para>
	/// <para>
	...
	{
		private const string c_SlotName = "Mammothcode.Public.Core.Util.LogicalThreadContextProperties";
