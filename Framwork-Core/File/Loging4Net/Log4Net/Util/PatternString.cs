...
namespace Mammothcode.Public.Core.Util
{
	...
	/// </para>
	/// <para>
	/// This class functions similarly to the <see cref="Mammothcode.Public.Core.Layout.PatternLayout"/>
	/// in that it accepts a pattern and renders it to a string. Unlike the 
	/// <see cref="Mammothcode.Public.Core.Layout.PatternLayout"/> however the <c>PatternString</c>
	...
	/// </para>
	/// <para>
	/// See the <see cref="Mammothcode.Public.Core.Layout.PatternLayout"/> for details on the 
