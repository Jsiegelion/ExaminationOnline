...
using Mammothcode.Public.Core.DateFormatter;
using Mammothcode.Public.Core.Core;

namespace Mammothcode.Public.Core.Util.PatternStringConverters
{
	/// <summary>
	...
	/// The value of the <see cref="Mammothcode.Public.Core.Util.PatternConverter.Option"/> determines 
	...
	internal sealed class EnvironmentPatternConverter : PatternConverter
	{
		...
		/// using the <see cref="Mammothcode.Public.Core.Util.PatternConverter.Option"/>
		/// property.
		/// </para>
		/// </remarks>
