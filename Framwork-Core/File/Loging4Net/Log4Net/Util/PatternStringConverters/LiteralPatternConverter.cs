...
namespace Mammothcode.Public.Core.Util.PatternStringConverters
{
	...
	/// <see cref="Mammothcode.Public.Core.Util.PatternConverter.Option"/> property to 
	/// the output.
	/// </para>
	/// </remarks>
	...
	internal class LiteralPatternConverter : PatternConverter 
	{
		...
		/// </para>
		/// <para>
		/// Writes the value of <see cref="Mammothcode.Public.Core.Util.PatternConverter.Option"/>
