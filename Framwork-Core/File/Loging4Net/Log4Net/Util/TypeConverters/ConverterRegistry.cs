...
namespace Mammothcode.Public.Core.Util.TypeConverters
{
	/// <summary>
	...
	public sealed class ConverterRegistry
	{
		...
		static ConverterRegistry()
		{
			...
			AddConverter(typeof(Mammothcode.Public.Core.Layout.PatternLayout), typeof(PatternLayoutConverter));
			AddConverter(typeof(Mammothcode.Public.Core.Util.PatternString), typeof(PatternStringConverter));
