    ...
    public class JsApiPay
    {
        ...
        */
        public string GetJsApiParameters()
        {
            ...
            jsApiParam.SetValue("appId", unifiedOrderResult.GetValue("appid").ToString());
            jsApiParam.SetValue("timeStamp", ""+WxPayApi.GenerateTimeStamp().ToString()+"");
            jsApiParam.SetValue("nonceStr", WxPayApi.GenerateNonceStr().ToString ());
            jsApiParam.SetValue("package", "prepay_id="+ unifiedOrderResult.GetValue("prepay_id")+"".ToString());
            jsApiParam.SetValue("signType", "MD5".ToString());
            jsApiParam.SetValue("paySign", jsApiParam.MakeSign().ToString());
	    ...
	    */
        ...
        //        afterData.SetValue("appId", WxPayConfig.APPID.ToString());
        //        afterData.SetValue("scope", "jsapi_address");
        //        afterData.SetValue("signType", "sha1");
        //        afterData.SetValue("addrSign", addrSign.ToString());
        //        afterData.SetValue("timeStamp", signData.GetValue("timestamp").ToString());
        //        afterData.SetValue("nonceStr", signData.GetValue("noncestr").ToString());

        //        //throw new WxPayException(""+afterData.ToPrintStr()+"");
        //        ////转为json格式
        ...
        ////文件写入
        //public void Write(string path,string  code)
        //{
