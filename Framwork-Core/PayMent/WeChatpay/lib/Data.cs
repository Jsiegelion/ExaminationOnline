    ...
    public class WxPayData
    {
        ...
        */
        public SortedDictionary<string, object> FromXml(string xml)
        {
            ...
            {
                //throw new WxPayException("<span style='color:#00CD00;font-size:20px'>222</span>");
        ...
        */
        public bool CheckSign()
        {
            ...
            {
                throw new WxPayException("222222");
                Log.Error(this.GetType().ToString(), "WxPayData签名存在但不合法!");
                throw new WxPayException("WxPayData签名存在但不合法!");
            }
            ...
            throw new WxPayException("<span style='color:#00CD00;font-size:20px'>" + cal_sign + ""+return_sign+"</span>");
